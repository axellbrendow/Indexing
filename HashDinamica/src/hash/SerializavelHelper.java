...
public class SerializavelHelper
{
     ...
     */
    public static void escreverObjeto(Serializavel serializavel,
            RandomAccessFile correnteDeSaida)
    {
        try
        {
     ...
     */
    public static void lerObjeto(Serializavel serializavel,
            RandomAccessFile correnteDeEntrada)
    {
        try
        {
     ...
     */
    public static void escreverObjeto(Serializavel serializavel,
            byte[] correnteDeSaida, int deslocamento)
    {
     ...
     * @param deslocamento Deslocamento em relação ao início.
     */
    public static void lerBytes(Serializavel serializavel, byte[] bytes,
            int deslocamento)
    {
        if (bytes != null)
        {
            ...
            if (restante > 0 && restante <= bytes.length)
            {
                ...
                System.arraycopy(bytes, deslocamento, bytesAproveitaveis, 0,
                        restante);
