...
public:
    ...
    /** Leia o texto do link abaixo para entender o porquê de eu usar o "using" aqui.
     * 
...
int main()
{
    ...
    ArvoreBMais<int, Student> arvore(fileName, 4);
    ...
    auto dados = arvore.listarDadosComAChaveEntre(10, 610);
    cout << endl;
